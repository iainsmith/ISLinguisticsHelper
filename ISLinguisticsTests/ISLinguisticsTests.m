...
#import "ISLinguisticsTests.h"
#import "ISLinguisticsHelper.h"

@interface ISLinguisticsTests ()
{
    NSString *_text;
...
@implementation ISLinguisticsTests
...
{
    NSArray *words = [[[ISLinguisticsHelper alloc] initWithString:_shortText] words];
...
{
    NSArray *sentences =[[[ISLinguisticsHelper alloc] initWithString:_text] sentences];
...
{
    NSArray *nouns = [[[ISLinguisticsHelper alloc] initWithString:_simpleText] nouns];
...
{
    NSArray *placeNames = [[[ISLinguisticsHelper alloc] initWithString:_text] placeNames];
...
{
    NSArray *personalNames = [[[ISLinguisticsHelper alloc] initWithString:_nameText] personalNames];
...
{
    NSArray *nouns = [[[ISLinguisticsHelper alloc] initWithString:@"these are mountains. There is my friends."] rootLowerCaseNouns];
